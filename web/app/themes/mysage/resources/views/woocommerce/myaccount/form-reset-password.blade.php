...
?>
<div class="ht-container-small !max-w-[496px] pb-12 xl:pb-20">
    ...
    <div class="bg-white">    
        ...
        <form method="post" class="woocommerce-ResetPassword lost_reset_password">
            ...
            <p class="woocommerce-form-row form-row">
                ...
                <button type="submit" class="w-full btn-md btn-solid-primary woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
            </p>
