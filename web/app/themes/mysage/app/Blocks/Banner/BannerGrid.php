...
class BannerGrid extends Block
{
    /**
     * The block name.
     *
     ...
     * @var string
     */
    public $view = 'blocks/banner/banner-grid';
     ...
     * @var string
     */
    public $description = 'A simple Banner Grid block.';
     ...
     * @var array
     */
    public $keywords = ['banner','grid','ht','custom'];
    ...
    {
        $bannerGrid = new FieldsBuilder('banner_grid');

        $bannerGrid
            ->addGroup('banner_grid', ['label' => 'Grid'])
                ->addRepeater('banners', [
                    ...
                    ->addImage('img', [
                        ...
                        'required' => 0,
                        'conditional_logic' => [
                            'field' => 'banner_type', 'operator' => '!=', 'value' => 'video'
                        ], 
                        'return_format' => 'array',
    ...
    {
        return ht_get_field('banner_grid');
    }
