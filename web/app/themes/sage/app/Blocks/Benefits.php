...
class Benefits extends Block
{
     ...
     * @var string
     */
    public $description = 'A simple Benefits block.';
     ...
     * @var array
     */
    public $keywords = ['ht','custom','benefits'];
    ...
    {
        return ht_get_field('benefits','options');
    }
